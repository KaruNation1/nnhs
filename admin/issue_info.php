    ...
    <div id="main">
        ...
        <div class="container">
            <form style="padding-top: 20px;" method="post">
                <button class="btn btn-success" style="float: left;" name="submit_m" type="submit">Send Email</button>
            </form>
                    ...
                    if(isset($_POST['submit_m']))
                    {
                        ...
                        while($row=mysqli_fetch_assoc($t))
                        {
                            ...
                            if($day<=2)
                            {
                                ...
                                $subject="Regarding to the book you borrowed.";
                                $msg="Hello!
        This is sent to notify you that you need to return the book (Id: ".$bid_m.") in two days.";
                                ...
                                else
                                {
                                    ?>
                                        <div class="alert alert-danger">
                                            <strong>Mail sent un-successfully.</strong>
                                        </div>
                                    <?php
                                }
