...
<body>
    ...
    <!--------searchbar--------->
    <div class="container">
        <h3 style="float: left;">Search one username at a time to approve admin request.</h3>
    ...
    <br><h2>Admin Request</h2>
    <?php

        if(isset($_POST['submit']))
        {
            $q=mysqli_query($db,"SELECT first,last,username,email from admin where username like
            ...
            else
            {
                ...
                ?>
                    <form method="post">
                    <button type="submit" name="submit1" style="background-color: #ffe5b4; font-weight: 700; font-size: 15px;" class="btn btn-deffault">
                    <span style="color: red;" class="glyphicon glyphicon-remove-sign"></span>&nbsp;Remove</button>
                    <button type="submit" name="submit2" style="background-color: #ffe5b4; font-weight: 700; font-size: 15px;" class="btn btn-deffault">
        ...
        {
            $res=mysqli_query($db,"SELECT first,last,username,email from admin where status='';");
