...
<body>
    <?php
        $b=mysqli_query($db,"SELECT * from `books` order by bcount desc limit 0,5 ;");
    ?>
    <div style="width: 100%; height: 50px; margin-top: -20px;">
        <div style="background-color: #CD5C5C; padding: 10px; width: 12.5%; height: 50px; float: left;">
            <h3 style="color: white; margin-top: 0px;">Trending:</h3>
        </div>
        <div style="background-color: #FFCC8F; width: 87.5%; height: 50px; float: left; padding: 10px;">
            <table>
                <?php
                    while($b2=mysqli_fetch_assoc($b))
                    {
                        echo "<tr style='color: #A25B5B; width: 200px; margin-top: 5px; float: left;'>";
    ...
    <div class="srch">
        <form class="navbar-form" method="post" name="form1">
            ...
            <label for="subject">Choose a Subject: </label>
                <select style="width: 80px; outline: none;" name="subject" id="">
                ...
                <button style="background-color: #ed6335; width: 80px;" type="submit" name="submit_s" class="btn btn-default">
                    <span class="glyphicon glyphicon-search"></span>
                </button>
                <br>
            
                <br><input class="form-control" type="text" name="search" placeholder="Search Books">
    ...
    <div class="srch">
        <form class="navbar-form" method="post" name="form1">
                ...
                <input class="form-control" type="text" name="bid" placeholder="Book Accession Number" required="">
                <button style="background-color: #ed6335; width: 80px;" type="submit" name="submit1" class="btn btn-default">Request</button>
    ...
    <?php
        ...
        else if(isset($_POST['submit_s']))
        {
            $s=mysqli_query($db,"SELECT * from books where `subject`='$_POST[subject]';");
            ...
            else
            {
                echo "<div class='wrapper'>";
                    ...
                    {
                        echo "<tr>";
                        echo "<td>"; echo $r['bid']; echo "</td>";
                        echo "<td>"; echo $r['name']; echo "</td>";
                        echo "<td>"; echo $r['authors']; echo "</td>";
                        echo "<td>"; echo $r['subject']; echo "</td>";
                        echo "<td>"; echo $r['edition']; echo "</td>";
                        echo "<td>"; echo $r['status']; echo "</td>";
                        echo "<td>"; echo $r['condition']; echo "</td>";
                        echo "<td>"; echo $r['quantity']; echo "</td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                echo "</div>";
